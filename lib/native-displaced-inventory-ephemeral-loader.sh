...
RM=/bin/rm
RMDIR=/bin/rmdir
LAUNCHER_SHA=5e7579878f8c4facbac4d4fe2cc300f77f6a9e0954ef7f2da42d11778b489dd5
...
[[ "$capture_nonce" =~ ^[a-f0-9]{64}$&&"$native_sha" == 85f21a0039aa785906dd7bc9c8db200ecb30d5d88b76328e8e1656c7f432de20&&"$native_bytes" == 96504 ]]||fail 'invalid release binding'
