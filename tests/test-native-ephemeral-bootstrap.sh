...
assert len(encoded)==policy['launcher_encoded_bytes']==47929 and hashlib.sha256(encoded).hexdigest()==policy['launcher_encoded_sha256']=='841219b76eadd8fefe6c3609b35b8d9ad687f5f14be7b9a50ac68a324815bd16'
assert len(binary)==policy['launcher_binary_bytes']==35944 and hashlib.sha256(binary).hexdigest()==policy['launcher_binary_sha256']=='5e7579878f8c4facbac4d4fe2cc300f77f6a9e0954ef7f2da42d11778b489dd5'
...
grep -Fq '#define HELPER_SHA256 "85f21a0039aa785906dd7bc9c8db200ecb30d5d88b76328e8e1656c7f432de20"' "$SOURCE"||fail helper_sha_not_compiled
...
/usr/bin/env -i PATH=/usr/bin:/bin:/usr/sbin:/sbin /bin/bash --noprofile --norc "$probe" "$SITE" "$nonce" 85f21a0039aa785906dd7bc9c8db200ecb30d5d88b76328e8e1656c7f432de20 96504 inventory '' >"$out"
...
if /bin/bash "$probe" "$SITE" "$diagnostic_nonce" 85f21a0039aa785906dd7bc9c8db200ecb30d5d88b76328e8e1656c7f432de20 96504 diagnostic '' >"$TMP/diagnostic.out" 2>"$diagnostic_err";then fail stable_diagnostic_unexpected_success;fi
...
runtime_identity='loader=DEGRADED_ASSURANCE_EPHEMERAL_BOOTSTRAP_V1|launcher_sha=5e7579878f8c4facbac4d4fe2cc300f77f6a9e0954ef7f2da42d11778b489dd5|launcher_meta=0:0:700:1:2:35944|helper_sha=85f21a0039aa785906dd7bc9c8db200ecb30d5d88b76328e8e1656c7f432de20|transport=sealed_memfd_execveat_v1'
...
if /bin/bash "$TMP/bad-probe.sh" "$SITE" "$bad_nonce" 85f21a0039aa785906dd7bc9c8db200ecb30d5d88b76328e8e1656c7f432de20 96504 inventory '' >/dev/null 2>&1;then fail hash_mismatch_accepted;fi
...
if /bin/bash "$probe" "$SITE" "$collision_nonce" 85f21a0039aa785906dd7bc9c8db200ecb30d5d88b76328e8e1656c7f432de20 96504 inventory '' >/dev/null 2>&1;then fail preexisting_directory_accepted;fi
...
if /bin/bash "$probe" "$SITE" "$collision_nonce" 85f21a0039aa785906dd7bc9c8db200ecb30d5d88b76328e8e1656c7f432de20 96504 inventory '' >/dev/null 2>&1;then fail symlink_accepted;fi
