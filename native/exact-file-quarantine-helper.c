...
static void reconcile_rollback(void){
    ...
    for(size_t i=0;i<target_count;i++){
        Target *t=&targets[i];int live_fd=open_exact_at(t->live_parent,t->live_name,t,0);int q_fd=open_exact_quarantine_recovery(t->quarantine_parent,t->quarantine_name,t);
